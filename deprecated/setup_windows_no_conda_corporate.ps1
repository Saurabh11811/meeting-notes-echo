...
if (-not $chrome) {
    throw "Google Chrome was not found. This app uses installed Chrome via Playwright channel='chrome'. Install Chrome manually or ask IT to deploy it."
}

Write-Host "Chrome found: $chrome"

Write-Step "Skipping Playwright bundled Chromium download"
$env:PLAYWRIGHT_SKIP_BROWSER_DOWNLOAD = "1"
Write-Host "This app uses installed Google Chrome. No Playwright Chromium CDN download is required."
